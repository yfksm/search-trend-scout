      ...
      <div className="flex items-center justify-between pb-6 border-b border-border">
        <div>
          ...
          <p className="text-muted text-lg">
            Manage your ingestion sources and LLM preferences (MVP Preview).
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="glass-panel p-6 rounded-2xl space-y-4">
          ...
          <p className="text-muted text-sm mb-4">
            In MVP Phase 1, sources are predefined in the database. Currently
            tracking default search engineering RSS feeds.
          </p>
          <div className="space-y-3">
            <div className="flex justify-between items-center p-3 bg-card border border-border rounded-xl">
              ...
              <span className="text-xs px-2 py-1 bg-emerald-500/20 text-emerald-500 rounded-lg">
                Active
              </span>
            </div>
            <div className="flex justify-between items-center p-3 bg-card border border-border rounded-xl">
            ...
            <div className="flex justify-between items-center p-3 bg-card border border-border rounded-xl opacity-50">
              ...
              <span className="text-xs px-2 py-1 bg-border text-muted rounded-lg">
                Phase 2
              </span>
            </div>
          </div>
        ...
        <div className="glass-panel p-6 rounded-2xl space-y-4">
          ...
          <div className="space-y-4 text-sm text-muted">
            <div>
              ...
              <select
                disabled
                className="w-full bg-card border border-border p-3 rounded-xl opacity-70 cursor-not-allowed"
              >
            ...
            <p className="italic mt-4 text-xs">
              Scoring weights and LLM keys are configured directly via `.env` in
              this minimal launch phase.
            </p>
          </div>
        </div>
      </div>
